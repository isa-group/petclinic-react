...
class PetServiceTests {
    ...
    void shouldCheckLimitForBasic() {
        ...
        createPet("wario1", owner);
        PricingPlanEvaluationException ex = assertThrows(PricingPlanEvaluationException.class,
                () -> createPet("wario2", owner));
        assertEquals("You have reached the limit of the feature: pets", ex.getMessage());
    }
