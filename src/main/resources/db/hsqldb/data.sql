...
INSERT INTO clinic_owners VALUES (1, 'John', 'Doe', 1);
INSERT INTO clinic_owners VALUES (2, 'Jane', 'Doe', 2);
...
INSERT INTO	owners(id, first_name, last_name, address, city, telephone, user, clinic) VALUES (1, 'George', 'Franklin', '110 W. Liberty St.', 'Sevilla', '608555103', 2, 1);
INSERT INTO owners(id, first_name, last_name, address, city, telephone, user, clinic) VALUES (2, 'Betty', 'Davis', '638 Cardinal Ave.', 'Sevilla', '608555174', 3, 1);
INSERT INTO owners(id, first_name, last_name, address, city, telephone, user, clinic) VALUES (3, 'Eduardo', 'Rodriquez', '2693 Commerce St.', 'Sevilla', '608558763', 4, 1);
INSERT INTO owners(id, first_name, last_name, address, city, telephone, user, clinic) VALUES (4, 'Harold', 'Davis', '563 Friendly St.', 'Sevilla', '608555319', 5, 2);
INSERT INTO owners(id, first_name, last_name, address, city, telephone, user, clinic) VALUES (5, 'Peter', 'McTavish', '2387 S. Fair Way', 'Sevilla', '608555765', 6, 2);
INSERT INTO owners(id, first_name, last_name, address, city, telephone, user, clinic) VALUES (6, 'Jean', 'Coleman', '105 N. Lake St.', 'Badajoz', '608555264', 7, 2);
INSERT INTO owners(id, first_name, last_name, address, city, telephone, user, clinic) VALUES (7, 'Jeff', 'Black', '1450 Oak Blvd.', 'Badajoz', '608555538', 8, 3);
INSERT INTO owners(id, first_name, last_name, address, city, telephone, user, clinic) VALUES (8, 'Maria', 'Escobito', '345 Maple St.', 'Badajoz', '608557683', 9, 3);
INSERT INTO owners(id, first_name, last_name, address, city, telephone, user, clinic) VALUES (9, 'David', 'Schroeder', '2749 Blackhawk Trail','Cádiz', '685559435', 10, 3);
INSERT INTO owners(id, first_name, last_name, address, city, telephone, user, clinic) VALUES (10, 'Carlos', 'Estaban', '2335 Independence La.', 'Cádiz', '685555487', 11, 1);
