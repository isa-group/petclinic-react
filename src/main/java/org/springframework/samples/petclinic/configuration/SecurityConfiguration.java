    ...
    protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/clinicOwners/all"))
                        .hasAuthority(ADMIN)
                        ...
                        .requestMatchers(AntPathRequestMatcher.antMatcher(HttpMethod.GET, "/api/v1/vets/stats"))
                        .hasAuthority(ADMIN)
