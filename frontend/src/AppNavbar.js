...
function AppNavbar() {
        ...
        if (role === "ADMIN") {
            adminLinks = (
                <>
                    ...
                    <NavItem>
                        <NavLink style={{ color: "white" }} tag={Link} to="/parserPlansAdmin/1">Plans Parser</NavLink>
                    </NavItem>
                </>
            )
        }
        if (role === "OWNER") {
            ownerLinks = (
                <>
                    ...
                    <Feature expression={feature("consultations")}>
                        <On>
                            <NavItem>
                                <NavLink style={{ color: "white" }} tag={Link} to="/consultations">Consultations</NavLink>
                            </NavItem>
    ...
    if (!jwt) {
        ...
        userLinks = (
            <NavItem>
                <NavLink style={{ color: "white" }} tag={Link} to="/home">Home</NavLink>
            </NavItem>
        )
        userLogout = (
            <>
